  ...
  public plantingGuideGeneratingPrompt(
    ...
    return `
        ...
        Guidelines:
            ...
            - "instructions" must contain sequential steps/instructions for that specific phase. Add as many steps as required for successful initial planting of this crop.
